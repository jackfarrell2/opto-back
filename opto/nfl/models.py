...
class UserPlayer(models.Model):
    ...
    user = models.ForeignKey(
        CustomUser, on_delete=models.CASCADE, related_name='user_nfl_players')
...
class UserOptoSettings(models.Model):
    ...
    user = models.ForeignKey(
        CustomUser, on_delete=models.CASCADE, related_name='user_nfl_opto_settings')
    ...
    offense_vs_defense = models.IntegerField(default=0)
...
class Optimization(models.Model):
    ...
    user = models.ForeignKey(
        CustomUser, on_delete=models.CASCADE, related_name='user_nfl_opto')
    slate = models.ForeignKey(Slate, on_delete=models.CASCADE)
